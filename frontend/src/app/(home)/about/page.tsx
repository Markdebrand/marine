  ...
  return (
    <section className="container mx-auto px-6 sm:px-8 lg:px-12 py-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-stretch">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-4 text-slate-700 leading-relaxed">
              A simple platform to view maritime traffic in real time and make
              quick decisions. Designed for operations and commercial teams that
              need visibility, context, and alerts without complexity.
            </p>
          </div>
          <div className="relative aspect-4/3 w-full overflow-hidden rounded-2xl bg-linear-to-br">
            <Image
              src="/images/about-us2webp.webp"
              alt="Marine Time"
              fill
      ...
      <div className="mt-10 section-surface">
        ...
        <ul className="mt-3 grid gap-4 sm:grid-cols-2 text-slate-700 text-sm">
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-red-50 ring-1 ring-red-200">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              Favorites and alerts by geofence/port to be notified in time.
            </span>
          </li>
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-red-50 ring-1 ring-red-200">
            ...
            <span>
              Security and licensing: governed data with privacy and control.
            </span>
          </li>
        </ul>
      </div>
      ...
      <div className="mt-10 section-surface">
        ...
        <ul className="mt-3 grid gap-4 sm:grid-cols-2 text-slate-700 text-sm">
          {[
            "Access with control and privacy; secure session.",
            "Data with proper licensing and retention.",
            "High availability; support for teams in operation.",
            "Gradual evolution without friction for users.",
          ].map((t, i) => (
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <div className="glass-card p-6">
          ...
          <p className="mt-2 text-slate-700 text-sm">
            No. The interface is straightforward: open the map, search a vessel,
            or mark your favorites. You’ll be operating in minutes.
          </p>
        </div>
        <div className="glass-card p-6">
          <div className="font-semibold text-slate-900">
          ...
          <p className="mt-2 text-slate-700 text-sm">
            Geofence entry/exit and port notifications. We’ll add more types
        ...
        <div className="glass-card flex items-center justify-between gap-4 p-6">
          <div>
            ...
            <p className="text-slate-700 text-sm">
              Request beta access or explore the map if you already have
              credentials.
            </p>
          </div>
          <a
            href="/map"
            className="inline-flex items-center rounded-xl bg-red-600 px-5 py-3 text-white text-sm font-medium hover:bg-red-700"
          >
