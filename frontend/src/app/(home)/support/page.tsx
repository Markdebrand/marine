...
export default function SupportPage() {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmitting(false);
            setSubmitted(true);
            setSuccess('Tu solicitud de soporte ha sido enviada correctamente. Nuestro equipo te responderá pronto.');
        ...
        <section className="container mx-auto px-6 sm:px-8 lg:px-12 py-12">
            <div className="grid gap-8 lg:gap-10 md:grid-cols-2">
                ...
                <div className="glass-card red-glow p-6 sm:p-8">
                    <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Support</h1>
                ...
                <div className="glass-card p-6 sm:p-8">
                    <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 text-center">HSO Marine Support</h2>
